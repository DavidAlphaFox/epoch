...
invalid_submit_param() ->
    ...
    L =
        [{[<<>>, ?HEX_VALID_16, ?HEX_VALID_16, lists:seq(1, 42)], user},
         {[false, ?HEX_VALID_16, ?HEX_VALID_16, lists:seq(1, 42)], user},
         {[1234, ?HEX_VALID_16, <<"aepool.com">>, 9876], user},
         {[<<" x ">>, ?HEX_VALID_16, <<"aepool.com">>, 9876], user},
         {[binary:copy(<<$1>>, 65), ?HEX_VALID_16, ?HEX_VALID_16, lists:seq(1, 42)], user},
         {[<<"user1">>, <<>>, ?HEX_VALID_16, lists:seq(1, 42)], job_id},
         {[<<"user1">>, 4894132, ?HEX_VALID_16, lists:seq(1, 42)], job_id},
         {[<<"user1">>, <<"error string">>, ?HEX_VALID_16, lists:seq(1, 42)], job_id},
         {[<<"user1">>, null, ?HEX_VALID_16, lists:seq(1, 42)], job_id},
         {[<<"user1">>, ?HEX_INVALID_16, ?HEX_VALID_16, lists:seq(1, 42)], job_id},
         %% TODO: miner nonce
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, <<>>], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, [0,1,2]], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, null], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, lists:seq(1, 41)], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, [4294967296 | lists:seq(1, 41)]], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, [-1 | lists:seq(1, 41)]], pow},
         {[<<"user1">>, ?HEX_VALID_16, ?HEX_VALID_16, lists:seq(1, 43)], pow}],
...
invalid_notify_param() ->
    ...
    L =
        [{[<<>>, 1, ?HEX_VALID_64, true], job_id},
         ...
         {[?HEX_VALID_16, null, ?HEX_VALID_64, true], block_version},
         {[?HEX_VALID_16, 1, <<>>, true], header_hash},
         {[?HEX_VALID_16, 1, null, true], header_hash},
         {[?HEX_VALID_16, 1, true, true], header_hash},
         {[?HEX_VALID_16, 1, 1234987, true], header_hash},
         {[?HEX_VALID_16, 1, ?HEX_INVALID_64, true], header_hash},
         {[?HEX_VALID_16, 1, <<?HEX_VALID_64/binary, 1:8>>, true], header_hash},
         {[?HEX_VALID_16, 1, ?HEX_VALID_64, <<>>], empty_job_queue},
         {[?HEX_VALID_16, 1, ?HEX_VALID_64, null], empty_job_queue},
         {[?HEX_VALID_16, 1, ?HEX_VALID_64, 129039], empty_job_queue},
         {[?HEX_VALID_16, 1, ?HEX_VALID_64, <<"true">>], empty_job_queue}],
    [{T, bin(B, P), M#{job_id => P1, block_version => P2, header_hash => P3, empty_job_queue => P4},
      {error, {invalid_param, R, I}}
     } || {[P1, P2, P3, P4] = P, R} <- L].
...
invalid_success_result_param(subscribe) ->
    ...
    M = #{type => rsp, id => I},
    L =
        [{[<<>>, ?HEX_VALID_16], session_id},
         {[true, ?HEX_VALID_16], session_id},
         {[<<"id">>, ?HEX_VALID_16], session_id},
         {[443243, ?HEX_VALID_16], session_id},
         {[?HEX_INVALID_16, ?HEX_VALID_16], session_id},
         ...
         {[?HEX_VALID_16, ?HEX_VALID_16, ?HEX_VALID_16], subscribe_params},
         {[[]], subscribe_params}],
